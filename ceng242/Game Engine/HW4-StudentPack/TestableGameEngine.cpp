...
void TestableGameEngine::runInternal() {
    std::cout << "Test 0: " << currentGrade << std::endl;
...
std::cout << "Test 1: " << currentGrade << std::endl;
    ...
    if(findTracerFirst == nullptr || findTracerFirst->getID() != tracerFirst->getID())
        currentGrade -= 1;
    std::cout << "Test 1.5: " << currentGrade << std::endl;
    ...
    //std::cout <<"WTF: "<< engine1[0]->getCoord() <<std::endl;
...
std::cout << "Test 4: " << currentGrade << std::endl;
    ...
    std::cout << "Test 4.1: " << currentGrade << std::endl;
