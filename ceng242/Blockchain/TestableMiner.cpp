...
std::cout << "Initial: " << currentGrade << std::endl;
    ...
    //std::cout << "Test 2.1: " << currentGrade << std::endl;
    for (int i = 0; i < blockchainToCreate; i++) {
    ...
    //std::cout << "Test 2.2: " << currentGrade << std::endl;
    ...
    std::cout << "Test 3.1: " << currentGrade << std::endl;
    /*
    -- BEGIN MINER --
    Miner name: ANTMiner
    Blockchain count: 1
     ...
     */
    antMiner.softFork(0);
    std::cout << "Test 3.2: " << currentGrade << std::endl;
    /*
    -- BEGIN MINER --
    Miner name: ANTMiner
    Blockchain count: 2
    ...
    std::cout << "Test 3.3: " << currentGrade << std::endl;

    if (pureBlockchain == nullptr || softForkedBlockchain == nullptr) {
        currentGrade -= 4;
        std::cout << "Test 3.35: " << currentGrade << std::endl;
    }
    else {
        std::cout << "Test 3.36: " << currentGrade << std::endl;
        *softForkedBlockchain *= 2;
        ...
        -- END MINER --
         */
        std::cout << "Test 3.4: " << currentGrade << std::endl;
        double pureBlockchainValue = 6.548;
        double softForkedBlockchainValue = 1.244;

        std::cout << "Test 3.5: " << currentGrade << std::endl;
